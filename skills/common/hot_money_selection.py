...
def _ladder_features(
    ...
    *,
    ...
    """Return bounded ladder microstructure used by P1 ranking gates."""
    ...
    # A ladder gap is the number of absent rungs between one and the height
    ...
    return {
        ...
        "height_change_3d": (
            dict(context.get("height_change_3d"))
            if isinstance(context, Mapping)
            and isinstance(context.get("height_change_3d"), Mapping)
            else height_change
        ),
        "promotion_rate_by_height": (
            dict(context.get("promotion_rate_by_height"))
            if isinstance(context, Mapping)
            and isinstance(context.get("promotion_rate_by_height"), Mapping)
            else promotion
        ),
...
def build_market_timing(
    ...
    *,
    ...
    ladder_features = _ladder_features(
        ...
        history=(context.get("ladder_history")
                 or context.get("lianban_ladder_history")
                 or context.get("ladder_snapshots")),
        quotes=observed,
        context=context,
    )
    ...
    *,
    ...
    return {
        ...
        "market_timing": {
            ...
            "ladder_gap": market.get("ladder_gap"),
            "height_change_3d": dict(market.get("height_change_3d") or {}),
            "promotion_rate_by_height": dict(
            ...
            "premium_by_state": dict(temperature.get("premium_by_state") or {}),
            "crowding_score": crowding.get("crowding_score"),
            "fragility_score": crowding.get("fragility_score"),
